...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "PetExplorer API", Version = "v1" });
    ...
    options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
    {
        ...
        Description = "Enter your JWT token as: {your token}"
    });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "PetExplorer API v1");
});
